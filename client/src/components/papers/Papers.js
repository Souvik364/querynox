...
const Papers = ({
  ...
  return (
    <section className="container">
      <h1 className="large text-primary">Manage Papers</h1>
      <p className="lead">
        <i className="fas fa-file-pdf"></i> Add and manage previous year question papers
      </p>
      ...
      <div className="mb-4">
        ...
        >
          {formVisible ? 'Close Form' : 'Add Paper'}
        </button>
      </div>
